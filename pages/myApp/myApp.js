  ...
  Loadmsg: function (Data) {
    ...
    for (i = 0; i < Data.length; i++) {
      ...
      this.data.listlost.push({
        username: userid, text: Msg, image: imageurl, imagelist: imageList, usericon: user_icon, sub_time: Submission_time, publish_id: publish_id, state: state
      });
